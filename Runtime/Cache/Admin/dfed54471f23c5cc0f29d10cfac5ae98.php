...
<body>
	...
	<script type="text/javascript" src="/ot/wwwroot/Public/static/uploadify/jquery.uploadify.min.js"></script>
			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="controls">
						...
						<?php if(!empty($info['icon'])): ?><div class="upload-pre-item"><img src="/ot/wwwroot<?php echo (get_cover($info["icon"],'path')); ?>"/></div><?php endif; ?>
						</div>
					</div>
					...
					$("#upload_picture").uploadify({
				        "height"          : 30,
				        "swf"             : "/ot/wwwroot/Public/static/uploadify/uploadify.swf",
					...
					function uploadPicture(file, data){
				        ...
				        if(data.status){
				        	$("#icon").val(data.id);
				        	src = data.url || '/ot/wwwroot' + data.path;
